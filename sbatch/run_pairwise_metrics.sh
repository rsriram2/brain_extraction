#!/bin/bash
#SBATCH --job-name=pairwise_metrics           # Job name
...
#SBATCH --output=pairwise_metrics_%j.out     # Standard output log
#SBATCH --error=pairwise_metrics_%j.err      # Standard error log
