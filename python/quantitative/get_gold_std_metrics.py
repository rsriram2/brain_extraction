...
def main():
    ...
    GOLD_DIR = '/dcs05/ciprian/smart/mistie_3/jhu_manual_segmentations/brain_extracted_double'
    GOLD_DIRS = [GOLD_DIR]
    ...
    if args.save_csv:
        per_scan_csv = os.path.join(args.out_dir, 'method_vs_gold_per_scan.csv')
        method_csv = os.path.join(args.out_dir, 'method_level_scan_summary.csv')
        subject_mean_csv = os.path.join(args.out_dir, 'method_subject_weighted_mean.csv')
        coverage_csv = os.path.join(args.out_dir, 'method_coverage.csv')
