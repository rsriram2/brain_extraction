...
overall   <- read.csv("/Users/rushil/ichseg/local_results/new/scan_lvl/Rushil_QC_results.csv")
artifact  <- read.csv("/Users/rushil/ichseg/local_results/new/scan_lvl/Rushil_QC_artifact_results.csv")
craniot   <- read.csv("/Users/rushil/ichseg/local_results/new/scan_lvl/Rushil_QC_craniotomy_results.csv")
cta       <- read.csv("/Users/rushil/ichseg/local_results/new/scan_lvl/Rushil_QC_cta_results.csv")
